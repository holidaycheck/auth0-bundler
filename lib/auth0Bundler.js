...
module.exports.bundleScript = R.partial(bundle, [ dependencies, { commonjs: false } ]);
module.exports.bundleRule = R.partial(bundle, [ dependencies, { commonjs: false } ]);
module.exports.bundleHook = R.partial(bundle, [ dependencies, { commonjs: true } ]);
